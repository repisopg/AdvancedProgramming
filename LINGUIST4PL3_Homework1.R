...
# Learning Objectives:
	...
	# Learn about GitHub markdown syntax
	
# Associated Resources:
	# GitHub docs has lots of information on getting started with GitHub:
		# https://docs.github.com/en/get-started/quickstart 

	# A video detailing the differences between git and GitHub as well as cloning, 
	# forking, commits and pull requests
...
# PART 2 - Create a Hello World repository and commit
	# Use the '+' drop down menu to select New repository
...
# PART 4 - Use GitHub markdown syntax
	# Navigate to your copy of the course repository
	# Open and edit the README file to add text
	# Add your name and explore GitHub markdown to add each of the following:
			# A large heading
			# An emoji
			# A text quote
	# Commit your changes to the main branch 
	#Markdown syntax is quite similar to RMarkdown syntax, but read about that on the guidelines:
...
#is ready to begin the process of merging new code changes with the main project repository.
	...
	# Open and edit the Homework1.R file
	# Add a link to your file pointing to your copy of the course repository and your name at the top where indicated (at the top of this file you will see Name: and Repository:)
	# Preview your changes and commit to the main branch
	
	# Navigate to the course repository on Github and click pull request
	# Select compare across forks and the course repository as the base repository (main branch)
  ...
  #Please, ask your questions on the discussion board.
